...
//*************************************************************************
//
// This test checks all relations of nets for VPI.
//
...
//    - short real nets (vpiShortRealNet)
//    - loads and drivers (FIXME: should probably be done?)
//    - net select (FIXME: should probably be done?)
...
#include "Vt_vpi_net_model_logic.h"
#include "verilated.h"
#include "svdpi.h"

#include "Vt_vpi_net_model_logic__Dpi.h"
...
#define FILENM "t_vpi_net_model_logic.cpp"
...
int mon_check() {
    ...
    CHECK_RESULT_NZ(vh_onereg);
    {
        ...
        CHECK_RESULT_CSTR2(p, "vpiLogicNet", "vpiNet");
    ...
    CHECK_RESULT_NZ(vha_u0);
    {
        ...
        CHECK_RESULT_CSTR2(p, "vpiArrayNet", "vpiNetArray");
        props->reset();
        props->m_scalar = true;
        props->m_array = true;
        props->m_name = "a_u0";
